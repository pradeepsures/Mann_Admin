...
export default function CorporateFilter({
  ...
  return (
    <div className="bg-white p-5 rounded-xl shadow mb-6">
      <h3 className="text-xl font-semibold mb-4">Corporate Filters</h3>
      ...
      <div className="flex gap-3 mt-5">
        <motion.button
          whileTap={{ scale: 0.95 }}
          onClick={handleApply}
          className="bg-primary text-white px-5 py-2 rounded-xl hover:bg-primary/90"
        >
          Apply Filters
        </motion.button>
        ...
        <motion.button
          whileTap={{ scale: 0.95 }}
          onClick={onReset}
          className="bg-gray-400 text-white px-5 py-2 rounded-xl hover:bg-gray-500"
        >
          Reset
        </motion.button>
      </div>
