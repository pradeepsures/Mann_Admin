...
export default function FuelLogsList() {
    ...
    const exportData = [
      {
        ...
        columns: [
          ...
          {
            label: "Date",
            value: (r) => new Date(r.date).toLocaleString(),
          },
        ],
        content: data,
      },
  ...
  const getVehicleName = (row) => {
    if (row?.vehicle) {
      return `${row.vehicle.brand || ""} (${row.vehicle.carNumber || ""})`;
    }
    return row?.carNumber || "N/A";
  };
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell>FUEL PRICE</StyledTableCell>
              <StyledTableCell>VEHICLE FIX AVG.</StyledTableCell>
              <StyledTableCell>CURRENT AVG.</StyledTableCell>
              <StyledTableCell>ODOMETER READING</StyledTableCell>
          ...
          <TableBody>
            {data.map((row, index) => (
              <TableRow key={row.id}>
                ...
                <TableCell>{getVehicleName(row)}</TableCell>
                ...
                <TableCell>{row?.driver?.name || "_"}</TableCell>

                <TableCell>{row.fuelType || "_"}</TableCell>

                <TableCell>{row.fuelQuantity || "_"}</TableCell>

                <TableCell>{row.fuelAmount || "_"}</TableCell>
                <TableCell>{row.fuelPrice || "_"}</TableCell>
                <TableCell>{row.currentVechicleAverage || "_"}</TableCell>
                <TableCell>{row.actualAverage || "_"}</TableCell>
                <TableCell>{row.odometerReading || "_"}</TableCell>
