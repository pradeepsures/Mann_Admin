...
// });
const driverFareSchema = z.object({
  perKmRate: z.union([z.number(), z.null()]).optional(),

  flatPerTrip: z.union([z.number(), z.null()]).optional(),

  minGuarantee: z.union([z.number(), z.null()]).optional(),

  allowancePerDay: z.union([z.number(), z.null()]).optional(),

  allowancePerNight: z.union([z.number(), z.null()]).optional(),

  overTimePerHour: z.union([z.number(), z.null()]).optional(),

  holidayAllowance: z.union([z.number(), z.null()]).optional(),
...
const pricingSchema = z
  .object({
    ...
    day: baseDayNightSchema.optional(),
    night: baseDayNightSchema.optional(),
